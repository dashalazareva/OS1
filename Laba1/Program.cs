                ...
                switch (choice)
                {
                    ...
                    case 2:
                        /*SECOND - FILE*/
                        {
                            ...
                            string path = @"C:\Users\dlaza\OneDrive\Рабочий стол\OS\";
                    ...
                    case 3:
                        /*THIRD - ZIP*/
                        {
                            ...
                            string SourceFile = @"C:\Users\dlaza\OneDrive\Рабочий стол\OS\cat.txt"; // исходный файл
                            string CompressedFile = @"C:\Users\dlaza\OneDrive\Рабочий стол\OS\book.gz"; // сжатый файл
                            string TargetFile = @"C:\Users\dlaza\OneDrive\Рабочий стол\OS\cat_new.txt"; // восстановленный файл
                    ...
                    case 4:
                        /*FORTH - XML*/
                        {
                            ...
                            xdoc.Add(list);
                            xdoc.Save(@"C:\Users\dlaza\OneDrive\Рабочий стол\OS\users.xml");
                            ...
                            switch (Console.ReadLine())
                            {
                                case "y":
                                    Console.WriteLine();
                                    xDoc.Load(@"C:\Users\dlaza\OneDrive\Рабочий стол\OS\users.xml");
                            ...
                            {
                                case "y":
                                    FileInfo xmlfilecheck = new FileInfo(@"C:\Users\dlaza\OneDrive\Рабочий стол\OS\users.xml");
                    ...
                    case 5:
                        /*FIFTH - JSON*/
                        {
                            ...
                            // сохранение данных
                            using (FileStream fs = new FileStream(@"C:\Users\dlaza\OneDrive\Рабочий стол\OS\user.json", FileMode.OpenOrCreate))
                            {
                            ...
                            {
                                case "y":
                                    File.Delete(@"C:\Users\dlaza\OneDrive\Рабочий стол\OS\user.json");
                                    Console.WriteLine("\nФайл удален!");
                                    break;
                                case "n":
                                    break;
